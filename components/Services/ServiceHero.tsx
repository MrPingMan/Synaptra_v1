      ...
      <div className="w-[90%] md:w-[80%] mx-auto grid items-center gap-10 pt-28 pb-16 sm:pt-32 sm:pb-20 xl:grid-cols-2">
        ...
        <div className="text-gray-300 mt-4 max-w-4xl">
          ...
          <p className="mt-6 max-w-3xl text-sm leading-7 text-slate-200 sm:text-base sm:leading-8">
            ...
            technological landscape. Our expert teams specialize in building
            high-performance applications, designing exceptional digital
            experiences, and implementing strategies that drive measurable
            business growth.
          </p>
          {/* Hero CTA button */}
          <a
            href="#web-development"
            className="mt-10 inline-flex rounded-full bg-cyan-300 px-8 py-4 text-sm font-semibold text-slate-950 transition hover:bg-cyan-200 sm:text-base"
          >
            Start Your Project
          </a>
        </div>
